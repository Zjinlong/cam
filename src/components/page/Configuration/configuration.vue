...
<div class="config">
    ...
    <el-tab-pane label="摄像头模型关联" name="fourth">
        <Relevance ref="fourth"/>
    </el-tab-pane>
       <!-- <el-tab-pane label="网关" name="third">
       <Gateway ref="third"/>
    </el-tab-pane> -->
  </el-tabs>
  </div>
